...
<head>
    ...
    <title>PT. Well Win Nusantara</title>
    ...
    <link rel="shortcut icon" href="{{ url('frontend/images/Logo terbaruhhhhh.png')}}" />
    
    <!-- CSRF Token -->
    <meta name="csrf-token" content="{{ csrf_token() }}">

    <title>{{ config('app.name', 'Wellwin Nusantara') }}</title>
...
<body data-spy="scroll" data-target=".navbar" data-offset="50">
    <div id="mobile-menu-overlay"></div>
		<nav class="navbar navbar-expand-lg fixed-top">
			<div class="container">
				<a class="navbar-brand" href="#"><img src="{{ url('frontend/images/Logo terbaruhhhhh.png')}}" alt="Marshmallow" height="42" width="42"></a>
				<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarTogglerDemo01" aria-controls="navbarTogglerDemo01" aria-expanded="false" aria-label="Toggle navigation">
				<span class="navbar-toggler-icon"><i class="mdi mdi-menu"> </i></span>
				</button>
				<div class="collapse navbar-collapse" id="navbarTogglerDemo01">
					<div class="d-lg-none d-flex justify-content-between px-4 py-3 align-items-center">
						<img src="{{ url('frontend/images/Logo terbaruhhhhh.png')}}" class="logo-mobile-menu" alt="logo" height="42">
					...
					<ul class="navbar-nav ml-auto align-items-center">
						...
						<li class="nav-item">
                         ...
                         @guest
                            <li class="nav-item">
                                <a class="nav-link" href="wp/wp-admin">{{ __('Login') }}</a>
                            </li>
